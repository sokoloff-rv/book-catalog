...
Веб‑приложение на Yii2 (basic) и MySQL для ведения каталога книг с несколькими авторами, подписками гостей и SMS‑уведомлениями через SMSpilot. Рабочая версия, включая отправку SMS, доступна по адресу: https://book-catalog.sokoloff-rv.ru/.
